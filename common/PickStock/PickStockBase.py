...
class PickStockBase(six.with_metaclass(ABCMeta, ParamBase)):
    def __init__(self, capital, benchmark, **kwargs):
        ...
        # 默认选股周期默认一年的交易日
        self.xd = Env.g_market_trade_year
        if 'xd' in kwargs and kwargs['xd'] > Env.g_market_trade_year:
            self.xd = kwargs['xd']

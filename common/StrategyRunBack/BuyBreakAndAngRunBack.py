from FactorBuy.FactorBuyBreakAndRegressAng import FactorBuyBreakAndRegressAng
...
def BuyBreakAndAngRunBack():
    csv_datalist = []
    FactorBuyBreakAndAngRunBack(csv_datalist=csv_datalist, vol_rank_min=1, vol_rank_max=1, stop_loss_n=2.0, stop_win_n=4.0, threshold_ang_min = 0.0, threshold_ang_max = 1.0)
    print(csv_datalist)
    # csv_datalist = []
...
def FactorBuyBreakAndAngRunBack(csv_datalist, xd_1 = 50, xd_2 = 21, vol_rank_min=0, vol_rank_max=1, stop_loss_n = 2.0, stop_win_n = 4.0, threshold_ang_min = 0.0, threshold_ang_max = 60.0):
    csv_columnslist = [xd_1, xd_2, vol_rank_min, vol_rank_max, stop_loss_n, stop_win_n, threshold_ang_min, threshold_ang_max]
    # 设置初始资金数
    read_cash = 1000000
    # 设置选股因子，None为不使用选股因子
    stock_pickers = None
    ...
    buy_factors = [{'xd': xd_1, 'rsi': 600, 'vol_rank_min': vol_rank_min, 'vol_rank_max': vol_rank_max, 'vol_daily': xd_1, 'threshold_ang_min': threshold_ang_min, 'threshold_ang_max': threshold_ang_max, 'class': FactorBuyBreakAndRegressAng},
                {'xd': xd_2, 'rsi': 600, 'vol_rank_min': vol_rank_min, 'vol_rank_max': vol_rank_max, 'vol_daily': xd_2, 'threshold_ang_min': threshold_ang_min, 'threshold_ang_max': threshold_ang_max, 'class': FactorBuyBreakAndRegressAng}
                ]

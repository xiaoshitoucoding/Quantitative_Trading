...
class AtrPosition(PositionBase):
    ...
    def _init_self(self, **kwargs):
        """atr仓位控制管理类初始化设置"""
        self.atr_base_price = kwargs.pop('atr_base_price', AtrPosition.s_atr_base_price)
        self.std_atr_threshold = kwargs.pop('std_atr_threshold', AtrPosition.s_std_atr_threshold)

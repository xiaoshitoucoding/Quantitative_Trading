...
from Position.PositionBase import PositionBase
from CoreBase.Market import MarketMixin



class OrderMarket(MarketMixin):
    """根据Order对象，设置混入类MarketMixin中symbol_name"""
    ...
    def __init__(self, order):
        ...
        if isinstance(order, Order):
            ...
            raise TypeError('order is Order object!!!')
...
class Order(object):
    ...
    def __str__(self):
        ...
        return 'buy Symbol = ' + str(self.buy_symbol) + '\n' \
               ...
               + 'sell_type_extra = ' + str(self.sell_type_extra) + '\n'

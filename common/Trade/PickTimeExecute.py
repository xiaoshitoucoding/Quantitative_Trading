...
# from .PickTimeWorker import PickTimeWorker
# from ..TradeBu import TradeExecute
from Trade.KLManager import KLManager
from Trade.PickTimeWorker import PickTimeWorker
from Trade import TradeProxy
...
def _do_pick_time_work(capital, buy_factors, sell_factors, kl_pd, benchmark, draw=False,
    ...
    pick_timer_worker = PickTimeWorker(capital, kl_pd, benchmark, buy_factors, sell_factors)
    if show_pg:
    ...
    orders_pd, action_pd, _ = TradeProxy.trade_summary(pick_timer_worker.orders, kl_pd, draw=draw,
                                                          show_info=show_info)

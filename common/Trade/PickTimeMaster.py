...
from Trade.PickTimeExecute import do_symbols_with_same_factors
from CoreBase import Env
from CoreBase.Env import EMarketDataFetchMode
from Trade.KLManager import KLManager
from CoreBase.Parallel import delayed, Parallel
...
class PickTimeMaster(object):
    ...
    @classmethod
    def do_symbols_with_same_factors_process(cls, target_symbols, benchmark, 
                                            buy_factors, sell_factors, capital,
                                            kl_pd_manager=None, n_process_kl=Env.g_cpu_cnt * 2,
        ...
        tmp_fetch_mode = Env.g_data_fetch_mode
        ...
        # 择时并行结束后恢复之前的数据获取模式
        Env.g_data_fetch_mode = tmp_fetch_mode
        orders_pd = None
        action_pd = None

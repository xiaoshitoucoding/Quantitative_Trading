...
from FactorBuy.FactorBuyBase import FactorBuyXD, BuyCallMixin
from Indicator.NDMa import calc_ma_from_prices
from CoreBase.PdHelper import pd_resample
from TLine.TLine import TLine


# noinspection PyAttributeOutsideInit
class DoubleMaBuy(FactorBuyXD, BuyCallMixin):
    """示例买入动态自适应双均线策略"""
    ...
    def _init_self(self, **kwargs):
        ...
        super(DoubleMaBuy, self)._init_self(**kwargs)
    ...
    def _dynamic_calc_fast(self, today):
        ...
        benchmark_month_line = TLine(benchmark_month.close, 'benchmark month line')
    ...
    """可以选择是否覆盖FactorBuyXD中的buy_tomorrow来增大交易频率，默认基类中self.skip_days = self.xd降低了频率"""

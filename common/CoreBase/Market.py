...
from CoreBase.Env import code_to_symbol
from Util.LazyUtil import LazyFunc

# from ..UtilBu import FileUtil
# from ..CoreBu import Env
# from ..CoreBu.Deprecated import Deprecated
# from ..CoreBu.Env import EMarketTargetType, EMarketSubType
# # noinspection PyUnresolvedReferences
# from ..CoreBu.Fixes import filter, zip
# from ..CoreBu.Fixes import KFold, six
# from ..UtilBu.LazyUtil import LazyFunc
# from ..MarketBu.Symbol import Symbol, code_to_symbol
# from ..MarketBu.SymbolFutures import FuturesCn, FuturesGB
# from ..MarketBu.SymbolStock import SymbolCN, SymbolUS, SymbolHK
...
#     :param market: 默认None，如None则服从Env.g_market_target市场设置
#     :return: list序列，序列中的每一个元素都是切割好的子symbol序列
#     """
#     if market is None:
#         # 取env中的Env.g_market_target设置
#         market = Env.g_market_target
...
#     """
#     if market is None:
#         # 如None则服从Env.g_market_target市场设置
#         market = Env.g_market_target
#     if market_symbols is None:
...
#     """
#     通过SymbolUS().all_symbol获取美股全市场股票代码
#     :param index: 是否包含指数
#     :return:
#     """

#     # noinspection PyProtectedMember
#     if Env._g_enable_example_env_ipython:
#         return K_SAND_BOX_US
#     return SymbolUS().all_symbol(index=index)


# def _all_cn_symbol(index=False):
#     """
#     通过SymbolCN().all_symbol获取A股全市场股票代码
#     :param index: 是否包含指数
#     :return:
#     """
#     # noinspection PyProtectedMember
...
#     """
#     通过SymbolHK().all_symbol获取A股全市场股票代码
#     :param index: 是否包含指数
#     :return:
#     """
#     # noinspection PyProtectedMember
...
#     return SymbolHK().all_symbol(index=index)


# def _all_futures_cn():
#     """
#     FuturesCn().symbol获取国内期货symbol代码，注意这里只取连续合约代码
#     :return:
#     """
...
# def _all_futures_gb():
#     """
#     FuturesGB().symbol获取国际期货symbol代码，LME，CBOT，COMEX
#     :return:
#     """
#     return FuturesGB().symbol
...
#     """
#     if market is None:
#         # None则服从Env.g_market_target市场设置
#         market = Env.g_market_target
...
#     if not FileUtil.file_exist(last_path_test):
#         raise RuntimeError('g_enable_last_split_test not fileExist(fn)!')
#     market_symbols = FileUtil.load_pickle(last_path_test)
#     return market_symbols
...
#     if not FileUtil.file_exist(last_path_train):
#         raise RuntimeError('g_enable_last_split_train not ZCommonUtil.fileExist(fn)!')
#     market_symbols = FileUtil.load_pickle(last_path_train)
#     return market_symbols
...
# """＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊Deprecated 旧数据格式文件＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊＊"""
# _rom_dir = Env.g_project_rom_data_dir
...
#     code = _slice[2]
#     if market == 'us':
#         m_type = SymbolUS().query_symbol_sub_market(code)
#     else:
#         m_type = EMarketSubType(market)
#     if m_type is not None and not (not index and is_index):
#         return Symbol(Env.g_market_target, m_type, code)


# @Deprecated('only read old symbol, miss update!!!')

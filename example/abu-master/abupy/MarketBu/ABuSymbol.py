...
#         """
#         if isinstance(market, EMarketTargetType) and isinstance(sub_market, EMarketSubType) and market_code_map.has_key(symbol_code):
#             self.market = market
...
def Symbol(market, sub_market, symbol_code):
    if(market_code_map.has_key(symbol_code)):
        return market_code_map[symbol_code]
    return ''

...
"""
SHORT = 12  # 快速移动平均线的滑动窗口长度。
LONG = 26  # 慢速移动平均线de 滑动窗口
...
DEFAULT_LOAD_BAR_NUM = 250

# EMA衰减时间：解决EMA起点不同，计算结果不同的问题。额外多查询215根bar计算EMA。
EXTRA_LOAD_BAR_NUM = 215
...
GOLD = 'gold'  # 金叉
DEATH = 'death'  # 死叉
DIF_LIMIT_TM = 'dif_limit_tm'  # DIF极值的日期
CLOSE_LIMIT_TM = 'close_limit_tm'  # 收盘价极值的日期
MACD_LIMIT_TM = 'macd_limit_tm'  # macd极值的日期
COLS = [CLOSE, DIF, DEA, MACD, GOLD, DEATH, DIF_LIMIT_TM, CLOSE_LIMIT_TM, MACD_LIMIT_TM]  # DateFrame的列， 缓存数据
ADJ_FACTOR = 'factor'
